...
void ArmorDetectorNode::imageCallback(const sensor_msgs::msg::Image::ConstSharedPtr img_msg)
{
  ...
  // std::cout << "color      "<< detector_->detect_color <<std::endl;
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  param_desc.integer_range[0].from_value = 0;
  param_desc.integer_range[0].to_value = 13457;
  ...
  const sensor_msgs::msg::Image::ConstSharedPtr & img_msg)
{
  ...
  if(detector_->unrecognized_num)
  {

    detector_->classifier->unrecognized_num_[0]=std::to_string(detector_->unrecognized_num/10000);
    ...
    if(detector_->unrecognized_num%10)
    {
  ...
  {
    detector_->classifier->unrecognized_num_[0]=("0");
    detector_->classifier->unrecognized_num_[1]=("0");
    detector_->classifier->unrecognized_num_[2]=("0");
    detector_->classifier->unrecognized_num_[3]=("0");
    detector_->classifier->unrecognized_num_[4]=("0");
  ...
  // if(detector_->unrecognized_num%10==7)
  // {
