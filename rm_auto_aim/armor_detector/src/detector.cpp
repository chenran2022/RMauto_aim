...
{
Detector::Detector(
  const int & bin_thres, const int & color, const int & un_num,const LightParams & l, const ArmorParams & a)
: binary_thres(bin_thres), detect_color(color), unrecognized_num(un_num), l(l), a(a)
{
}
